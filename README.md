...
|---|---|---|---|
| [TSMOM v3](strategies/tsmom_v3/) | **0.62** net | ✅ **7 of 7 — tradable** | Adds a per-asset leverage cap (10×, from broker margin — not optimised). Cap costs nothing: net Sharpe 0.610→0.618, turnover 19.55→16.11. Beats SPY on Sharpe/Calmar/Ulcer, loses on raw return. A risk tool, not a return tool. |
